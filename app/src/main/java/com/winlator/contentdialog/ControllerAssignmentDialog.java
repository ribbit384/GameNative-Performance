...
public class ControllerAssignmentDialog {
    ...
    private void initializeViews() {
        ...
        btnMacros[0].setOnClickListener(v ->
                com.winlator.contentdialog.MacrosDialog.show(hostActivity, 0, winHandler));
        ...
        btnMacros[1].setOnClickListener(v ->
                com.winlator.contentdialog.MacrosDialog.show(hostActivity, 1, winHandler));
        ...
        btnMacros[2].setOnClickListener(v ->
                com.winlator.contentdialog.MacrosDialog.show(hostActivity, 2, winHandler));
        ...
        btnMacros[3].setOnClickListener(v ->
                com.winlator.contentdialog.MacrosDialog.show(hostActivity, 3, winHandler));
    }
