...
public class Keyboard {
    ...
    public static boolean isKeyboardDevice(android.view.InputDevice device) {
        return device != null && (device.getSources() & android.view.InputDevice.SOURCE_KEYBOARD) != 0 && device.getKeyboardType() == android.view.InputDevice.KEYBOARD_TYPE_ALPHABETIC;
    }
