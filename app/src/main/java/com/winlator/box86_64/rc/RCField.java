...
public enum RCField {
    ...
    BOX64_MMAP32("BOX64_MMAP32", true),
    ...
    BOX64_DYNAREC_ALIGNED_ATOMICS("BOX64_DYNAREC_ALIGNED_ATOMICS", true),
    BOX64_DYNAREC_WEAKBARRIER("BOX64_DYNAREC_WEAKBARRIER", true, S.S3),
    BOX64_DYNAREC_NATIVEFLAGS("BOX64_DYNAREC_NATIVEFLAGS", true),
    BOX64_DYNAREC_PAUSE("BOX64_DYNAREC_PAUSE", true, S.S4),
