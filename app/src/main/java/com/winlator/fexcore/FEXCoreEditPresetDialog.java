        ...
        try {
            ...
            for (int i = 0; i < data.length(); i++) {
                ...
                if (item.optBoolean("toggleSwitch", false)) {
                    ...
                    spinner.setPopupBackgroundResource(isDarkMode ? R.drawable.content_dialog_background : R.drawable.content_dialog_background);
...
//        Context context = textView.getContext();
        ...
        if (isDarkMode) {
            ...
            textView.setBackgroundResource(R.drawable.content_dialog_background); // Set dark background color
        } else {
